...
const config = [
  ...
  // Premint.xyz Raffles
  {
    ...
    hiddenKey: '',
    options: [
      ['property', 'PREMINT_ENABLE', 'Enable raffle automation on premint.xyz website', '4', '5'],
    ...
    options: [
      ...
      [
        ...
        [
          ...
          ['propertyCell', 'USER_INFO_BTC_WALLET', 'ORD wallet'],
  ...
  // Raffles Page
  {
    ...
    options: [
      ...
      ['property', 'RAFFLE_LIST_FILTER_GTD', 'RAFFLE_LIST_FILTER_GTD', '', ''],
      ['space', 10],
      ...
      ['space', 10],
      ['description', 'RAFFLE_LIST_IGNORED_TEAMS config'],
      ['property', 'RAFFLE_LIST_IGNORED_TEAMS', 'RAFFLE_LIST_IGNORED_TEAMS', '', 'RAFFLE_LIST_IGNORED_TEAMS'],
    ],
  },

  // Raffles Page
  {
    header: 'Raffles Page 2',
    hiddenKey: '',
    options: [
      ['description', 'Search terms'],
      ['property', 'MY_RAFFLES_SEARCH_QUERY', 'MY_RAFFLES_SEARCH_QUERY', '', 'MY_RAFFLES_SEARCH_QUERY'],
      ['property', 'MY_RAFFLES_HANDLE_1', 'MY_RAFFLES_HANDLE_1', '', 'MY_RAFFLES_HANDLE_1'],
      ['property', 'MY_RAFFLES_HANDLE_2', 'MY_RAFFLES_HANDLE_2', '', 'MY_RAFFLES_HANDLE_2'],
      ['property', 'MY_RAFFLES_HANDLE_3', 'MY_RAFFLES_HANDLE_3', '', 'MY_RAFFLES_HANDLE_3'],
      ['property', 'MY_RAFFLES_HANDLE_4', 'MY_RAFFLES_HANDLE_4', '', 'MY_RAFFLES_HANDLE_4'],
    ],
  },
  ...
  // Misc
  {
    ...
    options: [
      ...
      [
        'property',
        'TWITTER_INTENT_PAGE_FOCUS_TAB_TIMES',
        'TWITTER_INTENT_PAGE_FOCUS_TAB_TIMES',
        '',
        'TWITTER_INTENT_PAGE_FOCUS_TAB_TIMES',
      ],
      [
        'property',
        'TWITTER_INTENT_PAGE_NUM_RETRIES',
        'TWITTER_INTENT_PAGE_NUM_RETRIES',
        '',
        'TWITTER_INTENT_PAGE_NUM_RETRIES',
      ],
      [
        'property',
        'TWITTER_INTENT_PAGE_TIME_BEFORE_RETRY',
        'TWITTER_INTENT_PAGE_TIME_BEFORE_RETRY',
        '',
        'TWITTER_INTENT_PAGE_TIME_BEFORE_RETRY',
      ],
